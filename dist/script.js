...
const changeModalState = state => {
  ...
  const windowForm = document.querySelectorAll('.balcon_icons_img'),
    //Получаем форму с табами
    windowWidth = document.querySelectorAll('#width'),
    //Получаем ширину балкона
    windowHeight = document.querySelectorAll('#height'),
    //Получаем высоту балкона
...
const forms = state => {
  ...
  (0,_checkNumInputs__WEBPACK_IMPORTED_MODULE_0__["default"])('input[name="user_phone"]'); //Проверяем пришедшие в форму данные перед использованием
  ...
  form.forEach(item => {
    item.addEventListener('submit', e => {
      ...
      if (item.getAttribute('data-calc') === 'end') {
        //Если у формы есть определенный html-атрибут, то добавим еще данные в нее
      ...
      .finally(() => {
        //Сработает в любом случае запроса
        clearInputs(); //Чистим инпуты
        setTimeout(() => {
          //Через 5сек удаляем блок с сообщением
...
const images = () => {
  ...
  workSection.addEventListener('click', e => {
    ...
    if (target && target.matches('div.popup')) {
      //По клику на подложку модалка закрывается
...
const modals = () => {
  function bindModal(triggerSelector, modalSelector, closeSelector, closeClickOverlay = true) {
    ...
    modal.addEventListener('click', e => {
      //Закрытие модалки по нажатию на подложку
      if (e.target === modal && closeClickOverlay) {
        //Если мы кликаем на модалку, то повторяем алгоритм нажатия на крестик
        windows.forEach(item => {
          item.style.display = 'none';
        });
        modal.style.display = 'none';
  ...
  function showModalByTime(selector, time) {
    //Функция для запуска модалки по таймеру
    setTimeout(function () {
  ...
  function calcScroll() {
    //Подсчитывает отступ для скролла в пикселях
...
const tabs = (headerSelector, tabSelector, contentSelector, activeClass, display = 'block') => {
  ...
  function showTabContent(i = 0) {
    //Показывает только определенный контент
  ...
  header.addEventListener('click', e => {
    ...
    if (target && target.classList.contains(tabSelector.replace(/\./, "")) || target.parentNode.classList.contains(tabSelector.replace(/\./, ""))) {
      tab.forEach((item, i) => {
        //item - перебираемый элемент, i - его номер
...
const timer = (id, deadline) => {
  ...
  const getTimeRemaining = endtime => {
    const t = Date.parse(endtime) - Date.parse(new Date()),
      //Считаем разницу между моментом с 1970 года и текущим моментом
      seconds = Math.floor(t / 1000 % 60),
      //Получаем секунды из t
      minutes = Math.floor(t / 1000 / 60 % 60),
      //Получаем минуты из t
  ...
  const setClock = (selector, endtime) => {
    ...
    function updateClock() {
      ...
      if (t.total <= 0) {
        //Если общее кол-во времени равно нулю, то зануляем данные и останавливаем таймер
        days.textContent = '00';
...
/* harmony import */ var jquery_migrate__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! jquery-migrate */ "./node_modules/jquery-migrate/dist-module/jquery-migrate.module.js");
/* harmony import */ var slick_carousel__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! slick-carousel */ "./node_modules/slick-carousel/slick/slick.js");
/* harmony import */ var slick_carousel__WEBPACK_IMPORTED_MODULE_2___default = /*#__PURE__*/__webpack_require__.n(slick_carousel__WEBPACK_IMPORTED_MODULE_2__);



console.log(jquery__WEBPACK_IMPORTED_MODULE_0__["default"].type("hello")); //Проверяю работу jquery migrate

(0,jquery__WEBPACK_IMPORTED_MODULE_0__["default"])(document).ready(function () {
  (0,jquery__WEBPACK_IMPORTED_MODULE_0__["default"])('.glazing_slider').slick({
    infinite: true,
    slidesToShow: 5,
    slidesToScroll: 1,
    responsive: [{
  ...
  (0,jquery__WEBPACK_IMPORTED_MODULE_0__["default"])('.decoration_slider').slick({
    infinite: true,
    slidesToShow: 4,
    slidesToScroll: 1,
    responsive: [{
...
;(function(factory) {
    'use strict';
    if (true) {
        !(__WEBPACK_AMD_DEFINE_ARRAY__ = [__webpack_require__(/*! jquery */ "./node_modules/jquery/dist/wrappers/jquery.bundler-require-wrapper.js")], __WEBPACK_AMD_DEFINE_FACTORY__ = (factory),
...
/***/ "./node_modules/jquery-migrate/dist-module/jquery-migrate.module.js"
/*!**************************************************************************!*\
  !*** ./node_modules/jquery-migrate/dist-module/jquery-migrate.module.js ***!
  \**************************************************************************/
...
var jQuery = jQueryFactory( jquery__WEBPACK_IMPORTED_MODULE_0__["default"], window );
...
window.addEventListener('DOMContentLoaded', () => {
  ...
  (0,_modules_forms__WEBPACK_IMPORTED_MODULE_3__["default"])(modalState); //Передаем стейт в форму, чтобы она при отправке знала, что ввел юзер
